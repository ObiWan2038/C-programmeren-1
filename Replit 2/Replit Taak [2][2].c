...
int main( void )
{
	typeVan8BytesKommaGetal getal1 = 0;
	typeVan8BytesKommaGetal getal2 = 0;

	printf( "Geef 2 reële getallen in: " );
	(void)scanf( "%lf %lf", &getal1, &getal2 );

	typeVan8BytesKommaGetal deling = getal1 /*arthimetic operator*/ getal2;
	typeVan8BytesKommaGetal product = getal1 /*arthimetic operator*/ getal2;
	typeVan8BytesKommaGetal som = getal1 /*arthimetic operator*/ getal2;
	typeVan8BytesKommaGetal verschil = getal1 /*arthimetic operator*/ getal2;
